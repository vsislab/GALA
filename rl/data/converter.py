...
from rl.data.batch import _parse_value, Batch


def to_numpy(
        x: Optional[Union[Batch, dict, list, tuple, np.number, np.bool_, Number, np.ndarray, torch.Tensor]]
...
def to_torch(
        x: Union[Batch, dict, OrderedDict, list, tuple, np.number, np.bool_, Number, np.ndarray, torch.Tensor],
        dtype: Optional[torch.dtype] = None,
        device: Union[str, int, torch.device] = "cpu",
) -> Union[Batch, dict, OrderedDict, list, tuple, torch.Tensor]:
